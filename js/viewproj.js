...
//                $('.row_activity.activity_'+ rowId ).data('parameters',JSON.stringify(parameterData));
    ...
    $(" #addDaysDays").on("change", function () {
        ...
        if ( taskDay != "" && taskstartday != "" ) {
            ...
            endproject.setDate(endproject.getDate() + parseInt(taskDay) -2); 
